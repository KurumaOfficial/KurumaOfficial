...
> Хочешь работать со мной? Пиши в Telegram — [@KurumaSeal](https://t.me/KurumaSeal). Только текст, без звонков.\
> Первое сообщение: задача, масштаб, дедлайн, бюджет. Сначала предоплата, потом работа.
>
> *PS: Прямо сейчас — Holo (не анонсирован) плюс закрытые инструменты Wettea. Сданная работа — в поддержке.*
