  ...
  <tr>
    <td width="42%" valign="middle" align="left" style="background:#0d1117; padding:16px 18px; border-radius:8px;">
      <p style="margin:8px 0 4px; font-size:13px; line-height:1.6; color:#c9d1d9;">
        ...
        • Бесплатных тестовых не делаю.<br/>
        • Сначала предоплата, потом работа.<br/>
        • Цена фиксируется один раз.<br/>
        • Сначала логи, потом вопросы.<br/>
        • Чего нет в тексте — того нет.<br/>
        • Что не использую — удаляю.<br/>
        • Старый код переписывается, а не латается вечно.<br/>
        • За трендами не гонюсь.<br/>
        • Одна задача за раз.
      </p>
      ...
      <p style="margin:4px 0 8px; font-size:13px; line-height:1.6; color:#c9d1d9;">
        ...
        • Плохой человек.<br/>
        • Тихий по умолчанию.<br/>
        • Редко онлайн.<br/>
        • Короткие ответы, длинный код.
      </p>
    </td>
...
> Хочешь работать со мной? Пиши в Telegram — [@Kuruma31](https://t.me/Kuruma31). Только текст, без звонков.\
> Первое сообщение: задача, масштаб, дедлайн, бюджет. Сообщения с одним «привет» игнорируются.\
> Отвечаю медленно, всегда по делу, на русском или английском.\
> Цена фиксируется один раз. Торг после договора — не про меня, срочность стоит дороже.\
> Сначала предоплата, потом работа. Нет предоплаты — нет места. Беру мало заказов за раз, так что место настоящее.\
> Масштаб поменялся посреди работы? Заказ начинается заново с оценки и новой цены.\
> Во время работы нет стендапов и дёрганий прогресса. Ты получишь результат, а не дневник.\
> Выпускаю или не выпускаю ничего. Сломанное с моей машины не уходит.\
> Ты получаешь код и короткие заметки по запуску. Тестируешь, подтверждаешь, заказ закрыт.\
> Мои баги чиню, твои новые идеи — это новый заказ.\
> Сданная работа живёт в поддержке. Новый масштаб — новый заказ, с новой ценой и новым местом в очереди.\
> Без звонков, митингов и бесплатных тестовых. Могу отказать в любом заказе без объяснений.
...
<!-- Чтобы добавить место работы, скопируй блок ниже: бейджи справа, роль, даты, место, пункты -->
