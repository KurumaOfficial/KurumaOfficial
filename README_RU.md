...
> Первое сообщение: задача, масштаб, дедлайн, бюджет. Сначала предоплата, потом работа.
>
> *Как идёт заказ: сообщения с одним «привет» игнорируются. Отвечаю медленно, всегда по делу, на русском или английском. Цена фиксируется один раз — торг после договора не про меня, срочность стоит дороже. Нет предоплаты — нет места, беру мало заказов за раз. Масштаб поменялся посреди работы? Заказ начинается заново с оценки и новой цены. Во время работы нет стендапов и дёрганий прогресса — ты получишь результат, а не дневник. Выпускаю или не выпускаю ничего, сломанное с моей машины не уходит. Ты получаешь код и короткие заметки по запуску: тестируешь, подтверждаешь, заказ закрыт. Мои баги чиню, твои новые идеи — это новый заказ. Сданная работа живёт в поддержке, новый масштаб — новый заказ с новой ценой и новым местом в очереди. Без звонков, митингов и бесплатных тестовых — могу отказать в любом заказе без объяснений.*
